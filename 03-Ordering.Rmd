...
- **Orders are placed by support staff every Tuesday and Thursday.** Many orders take several days for the shipment to arrive. If you use the last pipette or culture plate and we can't get any more for a week, everybody's work suffers! When in doubt, just order multiple boxes of things like pipettes or reorder immediately after you open the last box. 

- **Place order requests by adding information to the ordering documet.** Ask Becca if you have any questions or are struggling to find your desired item. All you have to do is email or call the sales department for a company and they will provide a quote to be used on your order. Names, contact information for sales reps, and updated product quotes should be recorded in the [Google Drive Purchasing Folder](https://docs.google.com/spreadsheets/d/1ZgihDKjzb143oBCUpU2VanAcNk0H_NbtXvUcyO6Vy2w/edit#gid=529170103). If you are ordering from a new vendor that is not in the Vanderbilt system, it might take several weeks to get them approved to purchase from. 
...
Departmental shoppers are able to create requisitions in Oracle, but are not able to submit their requisitions for processing. They must reassign their requisitions to a Procurement Requester for the order to be placed. Every lab member should become at least a Departmental Shopper as this allows you to see our contract prices. 
...
Procurement Requester are able to create and submit requisitions in Oracle. This is only necessary for support staff.
...
## How to place orders for designated departmental procurement requestors. Everyone else, please add your items to the ordering document above.
...
2. If the vendor is not a registered supplier with Vanderbilt, you will need to start the process, which can take a few weeks. Only purcurement requestors, not departmental shoppers, can do this process. You can email the CHBE office at chbeorders@vanderbilt.edu. The office staff will complete this for you. If they are not avialable, follow the ["New Supplier Requests" instructions](https://www.vanderbilt.edu/skyvu/procurement-requesters.php). 
